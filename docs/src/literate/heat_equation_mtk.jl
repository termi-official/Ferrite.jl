...
# using Ferrite, SparseArrays, ModelingToolkit, PDEBase
...
using Ferrite, SparseArrays, ModelingToolkit, PDEBase, SciMLBase
# Helpers
...
# function PDEBase.construct_discrete_space(vars::PDEBase.VariableMap, discretization::RitzGalerkinFEM{IP}) where {IP}
#     x̄ = vars.x̄
#     t = vars.time
# end
